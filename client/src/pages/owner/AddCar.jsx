...
const AddCar = () => {
  ...
  return (
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            ...
            <input type="text" placeholder='e.g. BMW, Mercede....' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} onChange={e=>setCar({...car,brand:e.target.value})}/>
          </div>
            <div className='flex flex-col w-full'>
            <label>
              Model
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            ...
            <input type="number" placeholder='e.g. 2019,2018' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.year} onChange={e=>setCar({...car,year:e.target.value})}/>
          </div>
            <div className='flex flex-col w-full'>
            <label>
    ...
    {/* Car transimison fue seating_capacity */}
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
       <div className='flex flex-col w-full'>
            <label>
              Transmission 
           ...
           <div className='flex flex-col w-full'>
            ...
            <input type="number" placeholder='e.g. 4,5...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.seating_capacity} onChange={e=>setCar({...car,seating_capacity:e.target.value})}/>
          </div>
 ...
 <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} type="text" placeholder='Enter your car description' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e=>setCar({...car,description:e.target.value})}></textarea>
          </div>
